...
const Navbar = () => {
    ...
    return (
        <div className='flex fixed items-start justify-between z-4 top-0 w-full'>
            <div className='lg:p-5 p-2'>
                <div onClick={()=>navigate("/")} className="lg:w-30 w-25 cursor-pointer">
            ...
            }} className='lg:h-12 h-10 lg:w-50 w-40 bg-black relative'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'>
                    <div className='relative py-4 flex flex-col gap-0.5 lg:gap-1 justify-center lg:px-10 px-8 items-end'>
